...
void setup()
{
 ...
 Serial.begin(115200);
  ...
  if(wifiConnected){
    ...
    lightOne = new Switch("Light One", 90, lightOneOn, lightOneOff);
    lightTwo = new Switch("Light Two", 91, lightTwoOn, lightTwoOff);
    lightThree = new Switch("Light Three", 92, lightThreeOn, lightThreeOff);
    lightFour = new Switch("Light Four", 93, lightFourOn, lightFourOff);
    outletOne = new Switch("Outlet One", 94,outletOneOn, outletOneOff);
    outletTwo = new Switch("Outlet Two", 95, outletTwoOn, outletTwoOff);
    outletThree = new Switch("Outlet Three", 96, outletThreeOn, outletThreeOff);
    outletFour = new Switch("Outlet Four", 97,outletFourOn, outletFourOff);
